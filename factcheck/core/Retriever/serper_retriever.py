...
class SerperEvidenceRetriever:
    ...
    def retrieve_evidence(self, claim_queries_dict, top_k: int = 2, snippet_extend_flag: bool = False):
    ...
    def _retrieve_evidence_4_all_claim(
        self, query_list: list[str], top_k: int = 2, snippet_extend_flag: bool = False
    ) -> list[list[str]]:
    ...
    def _request_serper_api(self, questions):
        ...
        # Exclude social media sites to ensure trusted sources
        exclusion_terms = " -site:facebook.com -site:twitter.com -site:x.com -site:instagram.com -site:tiktok.com -site:reddit.com"
        questions_data = [{"q": question + exclusion_terms, "autocorrect": False} for question in questions]
